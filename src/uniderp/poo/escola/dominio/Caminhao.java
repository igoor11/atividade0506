...
public class Caminhao extends BaseVeiculoT {
    ...
    public Caminhao(int codigo, String nome, String modelo, String cor, int anoModelo, int anoFabricacao, int assentos,
            ...
            String cidadeUF, String eixo, double pesoTotal, String pesoLiquido) {
    ...
    System.out.println("Tipo veículo: " + this.pesoLiquido);
    }
