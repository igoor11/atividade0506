...
public class Onibus extends BaseVeiculoT {
    ...
    public Onibus(int codigo, String nome, String modelo, String cor, int anoModelo, int anoFabricacao, int assentos,
            ...
            String cidadeUF, String eixo, double pesoTotal, String modelo2) {
    ...
    System.out.println("Tipo veículo: " + this.modelo);
    }
